...
> **Configuration Note:** The file paths defined in `config.py` point to local directories. Please ensure these paths are updated to match your specific local environment before executing the scripts.
